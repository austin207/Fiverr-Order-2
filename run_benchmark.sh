...
docker run \
    ...
    --env SINGLE_RUN_TIMEOUT_SEC="${SINGLE_RUN_TIMEOUT_SEC:-600}" \
    --env MAP_TIMEOUT_SEC="${MAP_TIMEOUT_SEC:-0}" \
    --env NAV2_ACTIVE_TIMEOUT_SEC="${NAV2_ACTIVE_TIMEOUT_SEC:-600}" \
    --env ODOM_WAIT_TIMEOUT_SEC="${ODOM_WAIT_TIMEOUT_SEC:-1200}" \
    --env MAX_SPAWN_RETRIES="${MAX_SPAWN_RETRIES:-1}" \
    --env START_MAP_INDEX="${START_MAP_INDEX:-0}" \
